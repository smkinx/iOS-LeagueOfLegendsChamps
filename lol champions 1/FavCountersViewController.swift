//
//  FavCountersViewController.swift
//  LOL Champions
//
...
class FavCountersViewController: UINavigationController {
    ...
    override func viewDidLoad() {
        ...
        self.title = champ + "'s Counters"
        //champ.lowercaseString
        //print(stadiumName)
        // Compose the query URL for Google's map API
        var query = "http://www.lolcounter.com/champions/\(champ.lowercaseString)"
