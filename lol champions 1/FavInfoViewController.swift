...
class FavInfoViewController: UINavigationController {

    var champ :String = "aatrox"
    ...
    override func viewDidLoad() {
        ...
        self.title = champ + " Information"
        //champ.lowercaseString
        //print(stadiumName)
        // Compose the query URL for Google's map API
        var query = "http://gameinfo.na.leagueoflegends.com/en/game-info/champions/\(champ.lowercaseString)/"
